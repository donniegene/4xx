...
function buildMenu() {
	return '<nav class="sidebar animated slideInLeft"><ul class="nav flex-column"><li class="nav-item"><a class="nav-link active" data-dest="link01" href="#>Active</a></li><li class="nav-link" data-dest="link02" href="#">Link</a></li><li class="nav-item"><a class="nav-link" data-dest="link03" href="#">Link</a></li><<li class+"nav-item"><a class="nav-link disabled" data-dest="link04" href="#">Disabled</a></li></ul></nav>';
